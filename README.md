# Python Learning Journey | Python学习历程

Welcome to my personal repository, where I document my **Python** learning journey. I am open to suggestions or corrections from fellow learners!  
本仓库记录了我个人学习**Python**的过程，欢迎各位提出宝贵意见和建议！

Windows | VS Code | Python 3.10.11

## Repository Overview | 本仓库介绍
**Demo001 ~ Demo100** are written using Python 3.10 syntax, as the original author's sample solutions were only provided in Python 2.0+ version. Each demo includes:  
**Demo001 ~ Demo100** 均采用 Python 3.10 语法编写，因为原作者的部分示例答案仅提供了 Python 2.0+ 版本。每个 Demo 包括：

1. The problem statement  
   题目描述
2. The solution code  
   求解代码
3. Some exercises include my personal thoughts and reflections on the solution at the end  
   部分题目会在末尾引入我的个人思考与对解决方案的反思
4. Multiple possible solutions for some problems  
   对部分题目给出多解

Feel free to explore the solutions, improve them, or discuss them with me!  
欢迎大家一起探索解决方案、提出改进意见或与我讨论！
...
- **Main Reference 1**: [Bilibili Uploader: 林粒粒呀](https://www.bilibili.com/video/BV1Jgf6YvE8e/), where I follow tutorials and concepts related to Python.  
  **主要参考 1**：[B站up主: 林粒粒呀](https://www.bilibili.com/video/BV1Jgf6YvE8e/)，在这里，我跟随教程学习 Python 相关概念。
...
欢迎大家浏览我的仓库、分享见解，或和我一起踏上这段激动人心的学习之旅！仓库包含两个主要文件夹：

- `py_learning`: Contains the content from [Bilibili Uploader: 林粒粒呀](https://www.bilibili.com/video/BV1Jgf6YvE8e/)
- `python_100_examples`: Contains the exercises from demo001 to demo100, from [菜鸟100题](https://www.runoob.com/python/python-exercise-example1.html)
